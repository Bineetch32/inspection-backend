...
public class InspectionRecordEntity {
    ...
    public Integer getQuantityChecked() { return quantityChecked; }
    public void setQuantityChecked(Integer quantityChecked) { this.quantityChecked = quantityChecked; }

    public Integer getOkQuantity() { return okQuantity; }
    public void setOkQuantity(Integer okQuantity) { this.okQuantity = okQuantity; }

    public Integer getNgQuantity() { return ngQuantity; }
    public void setNgQuantity(Integer ngQuantity) { this.ngQuantity = ngQuantity; }
    ...
    public String getPackagingPhoto() { return packagingPhoto; }
    public void setPackagingPhoto(String packagingPhoto) { this.packagingPhoto = packagingPhoto; }
    ...
    public Integer getExcelRowNumber() { return excelRowNumber; }
    public void setExcelRowNumber(Integer excelRowNumber) { this.excelRowNumber = excelRowNumber; }
}
